...
7. Describe more formally the above grammars. Use |, \*, or any symbols of your own invention.
   Imma skip this one cause I am bored
...
character: 'a' | 'b' | 'c' | ... | 'z' | 'A' | ... | 'Z' | '0' | ... | '9' | ' ' | '\\' <escape>;
