...
void test_grammar(void) {
  ...
  mpc_define(Expr, mpca_grammar(MPCA_LANG_DEFAULT,
                                " <product> (('+' | '-') <product>)* ", Prod));
  mpc_define(Prod, mpca_grammar(MPCA_LANG_DEFAULT,
                                " <value>   (('*' | '/')   <value>)* ", Value));
  mpc_define(Value, mpca_grammar(MPCA_LANG_DEFAULT,
                                 " /[0-9]+/ | '(' <expression> ')' ", Expr));
  ...
  t1 = mpc_ast_build(
      1, "product|>",
      mpc_ast_build(3, "value|>", mpc_ast_new("char", "("),
  ...
  t2 = mpc_ast_build(
      ...
      mpc_ast_build(
          3, "product|value|>", mpc_ast_new("char", "("),
          mpc_ast_build(
              3, "expression|>",

              mpc_ast_build(
                  5, "product|>", mpc_ast_new("value|regex", "4"),
                  mpc_ast_new("char", "*"), mpc_ast_new("value|regex", "2"),
                  mpc_ast_new("char", "*"), mpc_ast_new("value|regex", "11")),

              mpc_ast_new("char", "+"),
              mpc_ast_new("product|value|regex", "2")),
          mpc_ast_new("char", ")")),

      mpc_ast_new("char", "+"), mpc_ast_new("product|value|regex", "5"));

  PT_ASSERT(mpc_test_pass(
      Maths, "  24 ", t0, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));
  PT_ASSERT(mpc_test_pass(
      Maths, "(5)", t1, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));
  PT_ASSERT(mpc_test_pass(Maths, "(4 * 2 * 11 + 2) + 5", t2,
                          (int (*)(const void *, const void *))mpc_ast_eq,
                          (mpc_dtor_t)mpc_ast_delete,
                          (void (*)(const void *))mpc_ast_print));
  PT_ASSERT(mpc_test_fail(
      Maths, "a", t0, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));
  PT_ASSERT(mpc_test_fail(
      Maths, "2b+4", t0, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));
...
void test_language_file(void) {
  ...
  mpca_lang_contents(MPCA_LANG_DEFAULT, "./tests/maths.grammar", Expr, Prod,
                     Value, Maths);
...
void test_doge(void) {
  ...
  t0 = mpc_ast_build(
      4, ">", mpc_ast_new("regex", ""),
      mpc_ast_build(2, "phrase|>", mpc_ast_new("adjective|string", "so"),
  ...
  PT_ASSERT(mpc_test_pass(
      Doge, "so c so c", t0, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));

  PT_ASSERT(mpc_test_fail(
      Doge, "so a so c", t0, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));
...
void test_partial(void) {
  ...
  mpc_define(Line,
             mpca_tag(mpc_apply(mpc_sym("#line"), mpcf_str_ast), "string"));
  ...
  t0 = mpc_ast_build(
      3, ">", mpc_ast_new("regex", ""),
      mpc_ast_build(3, "linepragma|>", mpc_ast_new("line|string", "#line"),
...
void test_qscript(void) {
  ...
  mpc_err_t *err =
      mpca_lang(0,
                ...
                "   statement   : <function> '(' (<comment> | <parameter> | "
                "<block>)* ')'  <seperator> ;\n"
                "   function    : <qstring> ;\n"
                ...
                "   float       : /[-+]?[0-9]+\\.[0-9]+/ ;\n"
                "   int         : /[-+]?[0-9]+/ ;\n",
                Qscript, Comment, Resource, Rtype, Rname, InnerBlock, Statement,
                Function, Parameter, Literal, Block, Seperator, Qstring,
                SimpleStr, ComplexStr, Number, Float, Int, NULL);
  ...
  mpc_cleanup(18, Qscript, Comment, Resource, Rtype, Rname, InnerBlock,
              Statement, Function, Parameter, Literal, Block, Seperator,
              Qstring, SimpleStr, ComplexStr, Number, Float, Int);
}
...
void test_missingrule(void) {
  ...
  err = mpca_lang(MPCA_LANG_DEFAULT, "parser        : /^/ (<missing>)* /$/ ;\n",
                  Parser, NULL);

  /*  FIX: Catching the error at definition time seems a better choice at this
   * point and it makes the tests happy
   */
  PT_ASSERT(err != NULL);
...
void test_regex_mode(void) {
  ...
  PT_ASSERT(mpc_test_pass(
      Line0, "blah\nblah", t0, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));

  PT_ASSERT(mpc_test_pass(
      Line1, "blah\nblah", t1, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));

  PT_ASSERT(mpc_test_pass(
      Line2, "blah\nblah", t2, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));

  PT_ASSERT(mpc_test_pass(
      Line2, "blah", t3, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));

  PT_ASSERT(mpc_test_pass(
      Line3, "blah\nblah", t4, (int (*)(const void *, const void *))mpc_ast_eq,
      (mpc_dtor_t)mpc_ast_delete, (void (*)(const void *))mpc_ast_print));
...
void test_digits_file(void) {
  ...
  t0 = mpc_ast_build(5, ">", mpc_ast_new("regex", ""),
                     mpc_ast_new("digit|regex", "1"),
                     mpc_ast_new("digit|regex", "2"),
                     mpc_ast_new("digit|regex", "3"), mpc_ast_new("regex", ""));
